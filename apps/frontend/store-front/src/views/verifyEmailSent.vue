...
<v-sheet height="90vh" color="d-flex justify-center align-center">
    <v-container class='login d-flex flex-wrap align-center justify-space-around'>

       <v-sheet color="green" height="auto" width="50%" min-width="450px">
          <v-img src="../assets/message-sent-concept-illustration_114360-3363.jpg"></v-img>
       </v-sheet>
       <v-sheet height="100%" width="50%" min-width="450px" class="pl-8" >
            ...
            <p class="text-h6  mb-8 ">
                Check your mail to signin and verify
            </p>

            <p  class="text-subtitle-3 grey--text font-weight-bold mt-4 ">Did'nt get a confirmation email?</p>
            <p  class="text-subtitle-3  grey--text font-weight-bold">    
                check your spam or 
                <v-btn  small outlined :disabled="resendDisabled" class="mx-3 blue--text lighten-4  " @click="resendEmail">
                   resend 
