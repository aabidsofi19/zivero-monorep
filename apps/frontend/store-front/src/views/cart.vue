...
<div v-else class='container d-flex flex-wrap justify-around' id="cart">
    <div class="products"> <!--cart products-->
        ...
        <div class="pt-6 pb-2 text-subtitle-1 font-weight-bold darkGrey--text px-2  d-flex justify-space-between">
    ...
    <div class="price-details">
        <v-card
            ...
            <v-btn @click='goToAddress()' color="primary" tile elevation="1" class="white--text place-order-btn">
                PLACE ORDER
            </v-btn>
            <cartBottomnavigation class="bottom-navigation" @submit="goToAddress()" btnLabel="Place Order"> </cartBottomnavigation>
        </v-card>
