...
<div v-else >
  <div class="container d-flex flex-wrap justify-center main-container">
    ...
    <div class="addresses py-3">
      ...
      <div class="white py-4 d-flex justify-space-between">
        ...
        <v-btn outlined  class="" @click="addAddress()"> Add New Addrress </v-btn>
      </div>
      ...
      <div class="default-address">
        ...
        <addressCard :address="defaultAddress" v-if="defaultAddress" @updateAddress="updateAddress"/>
      </div>
      ...
      <div class="other-addresses">
          ...
          <addressCard  @updateAddress="updateAddress"  v-for="(address,i) of addresses" :key="i" :address="address" />
      </div>
    ...
    <div class="price-details">
        <v-card
            ...
            <v-btn   color="#266150" tile elevation="1" class="white--text continue-btn "
                @click="goToPayment()"
                :loading="submitting"
            ...
            <checkoutBottomNavigation  
                :loading="submitting"
                :disabled="btnDisabled"
                 class="bottom-navigation" btnLabel="Continue" @submit="goToPayment()">
            </checkoutBottomNavigation>
        </v-card>
  ...
  <updateAddressDialog ref="updateAddressDialog" :open="updateDialog" @updateDialog="closeUpdate"> </updateAddressDialog>
</div>
</template>
...
export default {
  components: {
      addressCard , checkoutProgress ,addressDialog,
      updateAddressDialog,paymentDetails,
      checkoutBottomNavigation,loading
     },
  data() {
    return {
      dialog:false ,
  ...
  computed:{
    ...mapState('addresses',['addresses',"defaultAddress","selectedAddress"]),
    btnDisabled(){
