...
<v-sheet v-if="success==true"  height="90vh" class="d-flex justify-center align-center px-6 " >
    <v-card width="350px" height="auto"  color="tan" class="pa-8  d-flex flex-column justify-space-center align-center">
        <v-sheet height="100px" color="pink" width="100px" class="mb-5 mt-8  rounded-circle">
        ...
        <v-btn block class="mb-8 green white--text">
            Start Shopping
        </v-btn>
    </v-card>
</v-sheet>
