<template>
    ...
    <div>
       ...
       <div class="d-flex flex-wrap justify-space-around  overflow-hidden " >
           ...
           <product-card class="product-card ma-0  pa-0 " :name="product.name" :image="product.variations[0].images[0]" 
              :price="product.variations[0].price"
              v-for="product in wishlist.products" :key="product.id" :id="product.id"
