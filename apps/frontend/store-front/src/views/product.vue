<template>
  ...
  <v-flex v-else class="grey d-flex flex-column">
    ...
    <div class="d-flex flex-row flex-wrap  justify-space-around product white">
      <product-carousal id="product-carousel"> </product-carousal>
      ...
      <div id="product-details">
        ...
        <v-card class="poppins pa-4"  width="auto" elevation="0" tile>
          ...
          <div class="text-h5 text-capitalize py-4 ">
            {{ product.name }}
          </div>
          <span class="d-flex py-3 justify-start price">
            ...
            <span class="text-decoration-line-through grey--text kpoppins">500</span>
        ...
        >
          ...
          <span class="d-flex flex-wrap justify-start" v-if="name=='color'">
            ...
            <span class="ma-1 mx-3 rounded-circle " :class="{'black':buttonSelected(name, value)}"
              v-for="(value, i) in variation" 
              :key="i">         <!-- outline for color selection -->
              <v-btn
              fab  
                elevation="0"
        ...
        <div tile class="mb-2 pa-3">
          <h2 class="text-subtitle-1 font-weight-bold text-uppercase pb-3 ">details</h2>
          <container class="poppins wrap" >
            {{ product.description }}
    ...
    </div>  <!-- end of product carousel and details flex -->


    <v-bottom-navigation class="pa-2 flex justify-center" round horizontal fixed>
      <v-btn color="grey " width="auto" height="95%" outlined class="mx-7 px-6 py-2">
