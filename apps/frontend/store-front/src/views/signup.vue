<template>
    ...
    <v-btn @click='signup' tile color='#266150' width='100%'
        class ='white--text'
        elevation='4'>
        SIGN UP
    </v-btn>
    <div class='mt-5'>
      ...
      <span>
      <v-btn @click='login' tile color='#000' width='40%%'
...
//import {LOGIN_EMAIL} from '../graphql/mutations/auth.js';
    ...
    export default { 
        ...
        methods:{
            ...
            async signup(){
                let {errors,success}=await this.$store.dispatch('user/registerUser',this.User)
