<template>
  <div class="product-preview container rounded" >
    ...
    <v-row height="">
      <v-col cols="3" >
        <v-img class="product-image mb-1" contain :src="variation.images[0]" height="200px"> </v-img>
      </v-col>
      <v-col cols="9">
        <div
        ...
        >
          <div class="pl-4">
            ...
            <div class="quantity  py-4 mx-0 justify-start align-center">
              ...
              <div><!--quantity-->
                <v-icon class="mx-1" @click="quantityPlus()" color="darkGrey"> mdi-plus </v-icon>

                <span class="mx-2">
                  {{ quantity }}
                </span>

                <v-icon class="mx-1" @click="quantityMinus()" color="darkGrey"> mdi-minus </v-icon>
              </div>
              
              <!-- selected variants -->
              <div class="d-flex justify-start py-5 ">
                <span  class="mr-4 grey darken-2 text-button rounded white--text px-3 "   v-for="(varaint,index ) in variation.variant" :key="index">
                  {{ varaint.value }}
                </span>
              </div>
            </div>
          ...
          <div class="py-3 pr-4">
            ...
            <p>
              <span class="text-decoration-line-through grey--text">Rs {{undiscountedPrice}}</span>
