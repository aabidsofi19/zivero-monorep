...
<div>
    ...
    <div class="" v-if="!loading">
      ...
      <div class="default-address" >
        ...
        <addressCard :address="defaultAddress" v-if="defaultAddress!==null" @updateAddress="updateAddress"/>
      </div>
...
export default {
  ...
  methods:{
    ...mapActions("addresses",["fetchAddresses","fetchDefaultAddress","addAddress"]),
