<template>
 <div class='cat my-10'> 
    <p class="text-h4 font-weight-medium pl-2 py-4 accent--text text-center " > Popular Categories </p>
    ...
    >   
      <!-- {{categories}} -->
       ...
       <categorySlideItem :category="category" v-for="category in categories" :key="category.name" @click.native="addCategoryFilter(category)"  />
