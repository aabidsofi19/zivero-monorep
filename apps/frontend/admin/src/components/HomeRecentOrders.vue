      ...
      <table class="table-fixed w-full">
        ...
        <tbody class="text-left text-gray-600">
          ...
          <tr>
            ...
            <!-- invoice -->
            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-right">#2384</th>
            <!-- invoice -->

            <!-- price -->
            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-right">$333</th>
            <!-- price -->
